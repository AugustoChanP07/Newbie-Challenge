...
artistid integer PRIMARY KEY, name text, address text, town text, county text, postcode yexy); """)
...
artistcountylbl.place(x = 770, y = 40, width=100, height= 25)
...
addarbtn = Button(text = "Add Piece", command= addart)
addarbtn.place(x = 110, y = 150, width= 130, height= 25)
...
searchmedium.place(x = 1020, y=330, width=50, height= 25)
searchmediumbtn = Button(text = " Search", command=searchmediumouput)
